...
from streamlit.components.v1 import st_bokeh_chart
...
def main():
    ...
    if start_game:
        ...
        while True:
            ...
            # Update frame with Streamlit
            updateFrame(screen, obstacles, skier, score)
            clock.tick(cfg.FPS)
            # Break the loop to prevent blocking Streamlit
            break
            
    st.image(pygame.surfarray.array3d(screen), caption='Game Frame', width=600)
